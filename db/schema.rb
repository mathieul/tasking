...
ActiveRecord::Schema.define(version: 20130819072345) do
  ...
  add_index "sprints", ["team_id", "number"], name: "index_sprints_on_team_id_and_number", unique: true, using: :btree
  ...
  add_index "tasks", ["teammate_id"], name: "index_tasks_on_teammate_id", using: :btree
