...
$ cd apps/tasking/current/wspubsub
$ foreman export upstart . -l $PWD/logs -u deploy -a wspubsub -p 8889
$ sudo su -
# cd /etc/init
# cp /home/deploy/apps/tasking/current/wspubsub/wspubsub* .
# service wspubsub start

== Test Websocket

Using wssh tool (https://github.com/progrium/wssh):

$ wssh -q 0 ws://wspubsub.cloudigisafe.com/web-socket\?room_id=teammates-3
